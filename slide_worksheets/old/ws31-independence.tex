...
\usebackgroundtemplate{%
	\includegraphics[width=2in]{images/spider}} 
\begin{document}
...
\usebackgroundtemplate{%
\hskip 3in
\includegraphics[width=1.5in]{images/ghost1}
} 
\begin{frame}{\fn}
...
\begin{frame}{\fn}
	...
	\begin{exa}
		...
		0 & 1 & -\frac{1}{2} & 0 & 0 \\
		0 & 0 & 0 & 1 & 0
		\end{bmatrix}.$$  Reading from the third column, this means that $\vec v_3=\frac{5}{2}\vec v_1-\frac{1}{2}\vec v_2$, or
...
\begin{frame}[fragile]
	...
	\end{exercise}
	\begin{picture}(0,0)
	\put(220,-30){\includegraphics[height=1in]{images/pumpkin1}}
	\end{picture}
\end{frame}
\begin{frame}{\fn}
...
\begin{frame}{\fn}
	...
	\end{block}
\begin{picture}(0,0)
\put(-20,-70){\scalebox{-1}[1]{\includegraphics[height=1in]{images/spookyhouse}}}
\end{picture}
\end{frame}
\begin{frame}{\fn}
	\begin{exercise}
