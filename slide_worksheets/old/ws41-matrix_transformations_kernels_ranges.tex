...
\begin{frame}{\fn}
	\begin{exercise}
		Consider the transformation $T:\R^3\to\R^2$ defined by the matrix
			\[A=\begin{bmatrix}
			-1 & -2 & 4 \\
			2 & 3 & 4
			\end{bmatrix}\]
...
\begin{frame}{\fn}
	\begin{block}{\textbf{Brain Break.}}
		Share your name and how many siblings you have.
			\begin{center}
				\includegraphics[height=.3\textheight]{images/families}
			\end{center}
...
\begin{frame}{\fn}
	\begin{recall}
		The range of a transformation $T:V\to W$ is the collection of all possible images under the transformation.  We write
			\[\operatorname{range}(T)=\{T(\vec v):\vec v\in V\}.\]
	\end{recall}
	\begin{statementblock}{Theorem 6.4}
		The range of a linear transformation $T:V\to W$ is a subspace of the codomain $W$.
	\end{statementblock}
...
\begin{frame}{\fn}
	\begin{statementblock}{The Range of a Matrix Transformation}
		If $T:\R^n\to\R^m$ is a matrix transformation defined by the $m\times n$ matrix $A$, then $\operatorname{range}(T)=\operatorname{col}(A)$.
	\end{statementblock}
	\begin{exercise}
	Consider the transformation $T:\R^3\to\R^2$ defined by the matrix
	\[A=\begin{bmatrix}
...
\begin{frame}{\fn}
	\begin{defn}
		Let $T:V\to W$ be a linear transformation.  The \emph{nullity} of $T$, denoted $\operatorname{nullity}(T)$, is the dimension of $\ker(T)$.
		
		The \emph{rank} of $T$, denoted $\rank(T)$, is the dimension of $\operatorname{range}(T)$.
	\end{defn}
	\begin{exercise}
		Consider the derivative transformation, $D:P_2\to P_1$.  What is the nullity and rank of $D$?
	\end{exercise}
\end{frame}
\begin{frame}{\fn}
	\begin{statementblock}{Theorem 6.5}
		Let $T:V\to W$ be a linear transformation from an $n$-dimensional vector space $V$ into a vector space $W$.  Then 
...
\begin{frame}{\fn}
	\begin{exercise}
		Find the rank and nullity of the matrix transformation $T:\R^3\to\R^3$ defined by	
			\[A=\begin{bmatrix}
			1 & 0 & -6 \\
			0 & 1 & -4\\
			0&0&0
